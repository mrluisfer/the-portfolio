...
const terminalLogs = [
  ...
  <pre key={3} className="hidden md:block">
    <span className="select-none">
      <BlueText>mrluisfer@</BlueText> <GreenText>~ $</GreenText>{' '}
    </span>
    <Link
  ...
  <pre key={'3-mobile'} className="block md:hidden">
    <span className="select-none">
      <BlueText>mrluisfer@</BlueText> <GreenText>~ $</GreenText>{' '}
    </span>
    <Link
      ...
      rel="noopener noreferrer"
    >
      <GrayText>cat poem.txt</GrayText>
    </Link>
  </pre>,
...
export default function Content() {
  ...
  return (
    <div className="overflow-wrap-anywhere font-mono text-sm leading-relaxed break-words text-gray-800 dark:text-gray-300">
